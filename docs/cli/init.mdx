---
title: charm init
summary: Scaffold a new Charm agent project with a single command.
---
...
| `--template` | Template to use. Defaults to `python`. Valid values: `python`, `openclaw`, `research-agent`, `code-review-agent`, `customer-support-agent`, `data-pipeline-agent`, `slack-bot`. |

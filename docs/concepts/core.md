...
### CharmTool
CharmTool creates a neutral abstraction layer for external tools, services, and modules. It transforms them into standardized system capability modules that can be injected into CrewAI Agents, LangGraph workflows, or pure Python scripts, achieving a true decoupling of capability and ecosystem.
### Agent as a Tool

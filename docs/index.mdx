...
<CardGroup cols={2}>
  ...
  <Card title="Onboarding" icon="terminal" color="#E8A694" href="guides/onboarding">
    Walk through the full workflow with guided examples.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="OAuth" icon="shield-halved" color="#E8A694" href="platform/oauth">
    Need integration with Google, GitHub, Notion, and more? The Store handles user account connections and automatically injects provider tokens directly into your runtime.
  </Card>

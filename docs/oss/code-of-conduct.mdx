...
description: Community expectations for contributing to Charm.
---
...
Security vulnerabilities should be reported through the private process in [`SECURITY.md`](https://github.com/CharmAIOS/Charm/blob/main/SECURITY.md), not through public issues or public community channels.

...
<Snippet file="snippets/base-image-mapping.mdx" />

## Custom Images

> [!TIP]
> **Community Plugins**: Instead of building your own image from scratch, you can discover pre-built custom runtimes with tools like FFmpeg or Chromium in the **Charm Store Plugins Registry**.

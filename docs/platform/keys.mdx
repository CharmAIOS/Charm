---
title: Tool API Keys
description: Learn how to declare tool permissions and API keys for your Charm Agents.
---
...
> [!IMPORTANT]
> **Never hardcode API keys in your Python or Node source code.** The Charm Cloud Runner securely resolves and injects these variables directly into your agent's execution container from the user's secure vault at runtime.

...
JSON Schema-style input, output, and optional state definitions. These control the generated forms and persistent memory structures.

### `ui`

Component definitions that map input keys to specific frontend rendering widgets (e.g. `textarea`, `file`, `date-picker`).

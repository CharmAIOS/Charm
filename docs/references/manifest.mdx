...
JSON Schema-style input and output definitions. These control the generated UI.

### `runtime`

Adapter, entry point, lifecycle, mode, skills, and environment variable requirements.
...
- [OAuth Integration Agent](/templates/oauth-integration)
